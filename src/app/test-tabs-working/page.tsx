      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <div className="flex items-center justify-center mb-4">
            ...
            {isAuthenticated && (
              <Button 
                onClick={() => setShowOnlyBooking(!showOnlyBooking)}
                variant={showOnlyBooking ? "default" : "outline"}
                size="sm"
                className="ml-2"
              >
                {showOnlyBooking ? "แสดง Test UI" : "ซ่อน Test UI"}
              </Button>
            )}
          </div>
        ...
        {/* ส่วนที่ 3: Booking Flow (แสดงตลอด) */}
        <BookingFlow />
